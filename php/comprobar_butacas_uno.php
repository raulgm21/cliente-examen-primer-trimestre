<?php
    ...
    for($i = 1 ; $i < 11 ; $i++){
       ...
       if($arrayButacas[$i] == "true"){
        $actualizarButaca = mysqli_query($conn, "UPDATE butacas SET estado='ocupado' WHERE codigo='BS1_0$i'");
       }

       if($arrayButacas[10] == "true"){
        $actualizarButaca = mysqli_query($conn, "UPDATE butacas SET estado='ocupado' WHERE codigo='BS1_$i'");
       }
